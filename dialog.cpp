...
void Dialog::readMyCom(){
    ...
    if (s == "a"){
        this->ligWeidget->setLight(1);//厨房
    }else if (s == "b"){
        this->ligWeidget->setLight(4);//卧室
    }else if (s == "c"){
        this->ligWeidget->setLight(2);//客厅
    }else if (s == "d"){
        this->ligWeidget->setLight(3);//卫生间
    }else if (s == "e"){ //安全
        this->patShowLab->setText("安全模式");
        this->patWeidget->setPattern("安全");
    }else if (s == "f"){ //离家
        this->patShowLab->setText("离家模式");
        this->patWeidget->setPattern("离家");
    }else if (s == "g"){ //生活
        this->patShowLab->setText("生活模式");
        this->patWeidget->setPattern("生活");
    }else if (s == "h"){ //睡眠
        this->patShowLab->setText("睡眠模式");
        this->patWeidget->setPattern("睡眠");
    }else if (s == "i"){ //温度加
        this->envWeidget->Add_Temperature();
    }else if (s == "j"){ //温度减
        this->envWeidget->Reduce_Temperature();
    }else if (s == "k"){ //湿度加
        this->envWeidget->Add_Humidity();
    }else if (s == "l"){ //湿度减
        this->envWeidget->Reduce_Humidity();
    }else if (s == "m"){ //电视
        this->equWeidget->reverseTvState();
    }else if (s == "n"){ //音响
        this->equWeidget->reverseAudioState();
    }
